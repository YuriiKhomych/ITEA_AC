...
# print(task_2_operations.rem_keys_not_cond(insights))

""" 3. Get all insights objectives into list of strings result:"""

# print(task_3_operations.rem_keys_not_cond(insights))

""" 4.,5. Get all insights objectives into dict of strings:"""

# print(task_4_5_operations.rem_keys_not_cond(insights))

""" 6. Get all unique insights objectives:"""

# print(task_6_operstions.get_unique(insights))
